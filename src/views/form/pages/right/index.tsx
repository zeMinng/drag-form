    ...
    <div className="componentConfig">
      ...
      {!isLayoutComponent && (
        <div className="config-section">
          <Divider size="small" dashed plain variant="dashed">基础信息</Divider>
      ...
      {config.propsConfig && Object.keys(config.propsConfig).length > 0 && (
        <div className="config-section">
          <Divider size="small" dashed plain variant="dashed">组件属性</Divider>
          <Form layout="vertical">
      ...
      {!isLayoutComponent && (
        <div className="config-section">
          <Divider size="small" dashed plain variant="dashed">校验规则</Divider>
          <ValidationEditor
...
const FormConfig: React.FC = () => {
  ...
  return (
    <div className="formConfig">
      <div className="config-section">
        <Divider size="small" dashed plain variant="dashed">表单信息</Divider>
        <Form layout="vertical">
        ...
        <Divider size="small" dashed plain variant="dashed">表单设置</Divider>
        <Form layout="vertical">
        ...
        <Divider size="small" dashed plain variant="dashed">恢复默认</Divider>
        <Form layout="vertical">
          <Form.Item>
            <Button 
              type="default" 
        ...
        <Divider size="small" dashed plain variant="dashed">组件统计</Divider>
        <div className="stats">
