...
```typescript
// 导入所有功能
import { generateVueComponent, getComponentConfig } from '@/pages/form/static'

// 或者按需导入
import { generateVueComponent } from '@/pages/form/static/core/generator'
import { buildPropsString } from '@/pages/form/static/utils/props'
```
